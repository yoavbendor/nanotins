...
// measured from; it must have been emitted by the walk for the region to resolve.
enum class RegionKind : std::uint8_t { udp_payload, tcp_payload, someip_payload };
...
//   <region>  udp_payload | tcp_payload | someip_payload
//
